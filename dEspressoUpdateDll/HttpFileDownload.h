...
protected:
	...
	CString		GetIdiskRunOnceFilePath();
	// variables	
#ifdef _URLDOWN
public:
...
private:	
	...
	// Folder information
	CString			m_strExecutePath;		// Current Application execute folder ex) C:\WINNT\Download Files\...
	CString			m_strDownPath;			// Idisk file folder ex) C:\Program Files\Down
