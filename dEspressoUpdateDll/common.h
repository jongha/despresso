...
#define UPDATEDLL "dEspressoUpdateDll"
...
#define UPDATE_RENAME_EXTENTION_NAME			".dEspresso_old"
#define UPDATE_REBOOT_EXTENTION_NAME			".dEspresso_update"
...
/*
<update-data>
	<file name=idisk2.exe>
		<type>exe;dll;txt;ocx;ini;</type>
		<version>3.1.1.1</version>
		<downurl>idisk.hitel.net/web/update/idisk2.exe</downurl>
		<downpath >%PROGRAMFILES%idisk%update</downpath>
		<description>idisk 실행 파일 입니다.</description>
		<force>yes</force>
		<regsrv>yes</regsrv>
	</file>
</update-data>
